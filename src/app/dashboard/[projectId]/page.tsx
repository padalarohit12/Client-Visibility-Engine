...
export default async function ProjectDashboardPage({
  ...
  const { projectId: projectName } = await params;

  // 1. Get the Project UUID by its name
  ...
  // 2. Fetch commits using the actual UUID
    ...
    <main className="min-h-screen bg-black text-white p-8 md:p-24 selection:bg-accent selection:text-white">
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <header className="space-y-4">
          ...
          <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-glow break-all">
            {projectName} Updates
          </h1>
